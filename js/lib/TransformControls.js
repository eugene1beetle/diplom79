	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		function onPointerMove( event ) {
			...
			if ( _mode === "translate" ) {
				...
				var scaling_speed = 0.01;

				if ( scope.space === "local" ) {

					if ( scope.axis === "XYZ" ) {

						scale = 1 + scaling_speed * ( ( point.y ) / Math.max( oldScale.x, oldScale.y, oldScale.z ) );
						...
						if ( scope.axis === "X" ) scope.object.scale.x = oldScale.x * ( 1 + scaling_speed * point.x / oldScale.x );
						if ( scope.axis === "Y" ) scope.object.scale.y = oldScale.y * ( 1 + scaling_speed * point.y / oldScale.y );
						if ( scope.axis === "Z" ) scope.object.scale.z = oldScale.z * ( 1 + scaling_speed * point.z / oldScale.z );
